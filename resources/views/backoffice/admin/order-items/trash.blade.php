...
@section('meta_title', 'Order Items Trash Bin')

@section('page_content')
    <div class="row align-items-center justify-content-between mb-3">
        <div class="col-12 col-md-auto mb-2 mb-md-0">
            <a href="{{ route('admin.order-items.index') }}" class="btn btn-light border shadow-sm">
                <i class="fas fa-arrow-left mr-1"></i> Back to Order Items
            </a>
        </div>
    ...
    <div class="card card-outline card-danger shadow-sm">
        <div class="card-header bg-white py-3">
            <form id="filterForm" method="GET" action="{{ route('admin.order-items.trash') }}" class="row g-2 align-items-center">
                <div class="col-12 col-md-6">
                    <div class="input-group input-group-sm">
                        <div class="input-group-prepend">
                            <span class="input-group-text bg-light border-right-0"><i class="fas fa-search text-muted"></i></span>
                        </div>
                        <input type="search" name="search" id="search" class="form-control border-left-0" placeholder="Search trashed items...">
                    </div>
                </div>
        ...
        <div class="card-body p-0 position-relative">
            ...
            <div id="tableContainer">
                @include('backoffice.admin.order-items.partials.table', ['isTrash' => true])
            </div>
        </div>
...
@push('js')
    @include('backoffice.admin.order-items.partials.script', ['fetchUrl' => route('admin.order-items.trash')])
@endpush