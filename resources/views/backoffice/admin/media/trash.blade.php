...
@section('page_content')
    <div class="row align-items-center justify-content-between mb-3">
        <div class="col-12 col-md-auto mb-2 mb-md-0">
            <h4 class="font-weight-bold mb-0"><i class="fas fa-trash-alt text-danger mr-2"></i>Media Trash</h4>
        </div>
        <div class="col-12 col-md-auto">
            <a href="{{ route('admin.media.index') }}" class="btn btn-light border btn-sm"><i class="fas fa-arrow-left mr-1"></i> Back to Media</a>
        </div>
    </div>
    ...
    <div class="card card-outline card-danger shadow-sm">
        <div class="card-header bg-white">
            <form method="GET" action="{{ route('admin.media.trash') }}" class="form-row align-items-end">
                ...
                <div class="col-12 col-md-5 text-md-right">
                    <button class="btn btn-danger btn-sm"><i class="fas fa-search mr-1"></i> Filter</button>
                    <a href="{{ route('admin.media.trash') }}" class="btn btn-light border btn-sm">Reset</a>
                </div>
            </form>
        </div>
            ...
            <div class="card-body border-bottom py-2">
                <div class="d-flex flex-wrap align-items-center">
                    ...
                    <select name="action" class="custom-select custom-select-sm mr-2" style="width: 220px;">
                        ...
                        @can('media.restore')<option value="restore">Restore Selected</option>@endcan
                        @can('media.force-delete')<option value="force-delete">Permanent Delete Selected</option>@endcan
                    </select>
