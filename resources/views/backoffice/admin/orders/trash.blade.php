...
@section('meta_title', 'Orders Trash Bin')
...
@section('page_content')
    ...
    <div class="card card-outline card-danger shadow-sm">
        <div class="card-header bg-white py-3">
            <form id="filterForm" method="GET" action="{{ route('admin.orders.trash') }}" class="row g-2 align-items-center">
                <div class="col-12 col-md-6">
                    <div class="input-group input-group-sm">
                        <div class="input-group-prepend">
                            <span class="input-group-text bg-light border-right-0"><i class="fas fa-search text-muted"></i></span>
                        </div>
                        <input type="search" name="search" id="search" class="form-control border-left-0" placeholder="Search trashed orders...">
                    </div>
                </div>
        ...
        <div class="card-body p-0 position-relative">
            ...
            <div id="tableContainer">
                @include('backoffice.admin.orders.partials.table', ['isTrash' => true])
            </div>
        </div>
...
@push('js')
    @include('backoffice.admin.orders.partials.script', ['fetchUrl' => route('admin.orders.trash')])
@endpush