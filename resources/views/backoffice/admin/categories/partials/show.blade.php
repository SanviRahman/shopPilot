<div class="modal fade" id="categoryShowModal" data-backdrop="static" data-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="categoryShowModalTitle" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
        <div class="modal-content border-0 shadow">
            <div class="modal-header bg-white border-bottom">
                <h5 class="modal-title font-weight-bold" id="categoryShowModalTitle">
                    <i class="fas fa-tags text-primary mr-2"></i>Category & SEO Details
                </h5>
            ...
            <div class="modal-body p-4">
                <div class="d-flex align-items-center mb-4 pb-3 border-bottom">
                    <div id="showCatImgWrapper" class="mr-3">
                        <img id="showCatImg" src="" alt="" class="img-thumbnail rounded" style="width: 60px; height: 60px; object-fit: cover;">
                    </div>
                    <div>
                        <h4 class="font-weight-bold mb-0 text-dark" id="showCatName"></h4>
                        <span class="text-muted small" id="showCatSlug"></span>
                    </div>
                    <div class="ml-auto text-right">
                        <span id="showCatStatus"></span>
                        <div class="small text-muted mt-1"><i class="fas fa-sort mr-1"></i>Order: <strong id="showCatSort"></strong></div>
                    </div>
                </div>
